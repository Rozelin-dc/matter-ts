...
export class Matter {
   ...
   */
  public static use(...params: (IPlugin | string)[]) {
    Plugin.use(this as Object, params)
  }
   ...
   */
  public static before(path: string, func: Function) {
   ...
   * @return The chained function that replaced the original
   */
  public static after = function (path: string, func: Function) {
    path = path.replace(/^Matter./, '')
